...
import {
    OctreeHelper
} from 'three/examples/jsm/helpers/OctreeHelper'
import {
    Capsule
} from 'three/examples/jsm/math/Capsule'
import {
    GLTFLoader
...
gui.add({
        cameraMoveSensitivity: cameraMoveSensitivity
    }, "cameraMoveSensitivity").step(0.1).min(0).max(1)
